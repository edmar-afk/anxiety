...
function Register() {
	...
	const [email, setEmail] = useState(""); // New email input
	...
	useEffect(() => {
		...
		if (firstName && password && password2 && email && !error) {
			setCanSubmit(true);
		} else {
			setCanSubmit(false);
		}
	}, [firstName, password, password2, email, error]);
					...
					<div className="flex justify-center w-full h-full my-auto">
						<div className="flex items-center justify-center w-full lg:p-12">
							<form
								...
								<h3 className="mb-3 text-4xl font-extrabold text-blue-900">Register</h3>
								<p className="mb-4 text-gray-700">Fill the form below to register</p>
