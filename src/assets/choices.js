export const questions = [
	{ id: 1, backgroundColor: "bg-blue-50", textColor: "text-blue-900", question: "What is stress?" },
	{ id: 2, backgroundColor: "bg-blue-100", textColor: "text-blue-800", question: "What are common causes of stress?" },
	{
		id: 3,
	...
	{ id: 4, backgroundColor: "bg-blue-300", textColor: "text-white", question: "Can meditation help manage stress?" },
	{
		id: 5,
	...
	{ id: 9, backgroundColor: "bg-blue-800", textColor: "text-white", question: "What causes stress?" },
	{
		id: 10,
	...
	{ id: 12, backgroundColor: "bg-green-800", textColor: "text-white", question: "How can I tell if I'm stressed?" },
	{
		id: 13,
	...
	},
	{
		...
		textColor: "text-green-900",
		question: "What role does sleep play in stress?",
	},
	{
		id: 21,
	...
	{ id: 22, backgroundColor: "bg-purple-800", textColor: "text-purple-50", question: "What is the stress response?" },
	{
		id: 23,
		backgroundColor: "bg-purple-700",
		textColor: "text-white",
		question: "What are some relaxation techniques?",
	},
	{
		id: 24,
		backgroundColor: "bg-purple-600",
		textColor: "text-white",
		question: "How can time management reduce stress?",
	},
	{
		id: 25,
		backgroundColor: "bg-purple-500",
		textColor: "text-white",
		question: "What should you avoid when stressed?",
	},
	{ id: 26, backgroundColor: "bg-purple-400", textColor: "text-purple-50", question: "Can stress make me sick?" },
	{
		id: 27,
		backgroundColor: "bg-purple-300",
		textColor: "text-gray-200",
		question: "How can I protect my health from stress?",
	},
	{
		id: 28,
		backgroundColor: "bg-purple-200",
		textColor: "text-purple-50",
		question: "How can stress affect my relationships?",
	},
	{
		id: 29,
		backgroundColor: "bg-purple-100",
		textColor: "text-purple-900",
		question: "How can I talk to my partner about my stress?",
	},
	{
		id: 30,
		backgroundColor: "bg-purple-50",
		textColor: "text-purple-900",
		question: "How can I support a loved one who is stressed?",
	},
	{
		id: 31,
